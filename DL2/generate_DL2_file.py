...
TELESCOP = {
    'lapalma': 'CTA-Nb.3AL4-BN15',
    'paranal': 'CTA-S.3HB9-FD',
}
...
def cli(filename, cut_level, debug, output, site):
    ...
    alt_pnt = data.array("ArrayPointing_Elevation", entrystart=0, entrystop=1)[0]
    az_pnt = data.array("ArrayPointing_Azimuth", entrystart=0, entrystop=1)[0]
    ...
    header['CREATOR'] = 'Eventdisplay g500'
    header['ORIGIN'] = 'CTA Collaboration', 'Data generated by G.Maier'
    header['ALT_PNT'] = alt_pnt, 'Average altitude of pointing [deg]'
    header['AZ_PNT'] = az_pnt, 'Average azimuth of pointing [deg]'
